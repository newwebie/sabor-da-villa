...
export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/5519988887777?text=Olá! Vim pelo site do Sabor da Villa e gostaria de mais informações."
      target="_blank"
    ...
    >
      {/* Pulse ring */}
      <span className="animate-pulse-ring absolute h-full w-full rounded-full bg-[#25D366]" />
      {/* Icon */}
      <svg
